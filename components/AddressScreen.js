...
const AddressScreen = ({ navigation }) => {
  ...
  const handleSaveAddress = () => {
    setSavedAddress({ address, aptSuite, selectedLocation, dropOffOption });
  };

  const handleCheckout = () => {
    navigation.navigate('Checkout', { savedAddress });
  };
    ...
    <View style={styles.container}>
      ...
      {savedAddress && (
        <View style={styles.savedAddressContainer}>
          ...
          <Text>{savedAddress.aptSuite}</Text>
          <Text style={styles.savedAddressTitle}>Drop-off Options:</Text>
          <Text>{savedAddress.dropOffOption}</Text>
